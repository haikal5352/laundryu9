...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	if(empty($_POST['jenis_laundry']) || empty($_POST['alamat']) || empty($_POST['lat']) || empty($_POST['lng']) || empty($_POST['hargaTotal'])){
    ...
    //Memasukkan Data Pesanan
		...
		$pdo->tambah_pesanan($_POST['jenis_laundry'], $_POST['beratBarang'], $_POST['jumlahBarang'],$_POST['alamat'], $_POST['catatan'], $_POST['lat'], $_POST['lng'], $_POST['hargaTotal'], $status, $_SESSION['id'], $_POST['list_satuan']);
    }
}
?>
							...
							<div class="inner">
								...
								<div class="form-row" id="kiloan_checked" name="kiloan_checked">
									<div class="form-holder form-holder-1">
										...
										<ol>
											<li>Perhitungan biaya berdasarkan 1 Kg = Rp. 6,000</li>
